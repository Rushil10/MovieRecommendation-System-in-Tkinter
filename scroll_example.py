...
def scroll(name='user10@gmail.com',open_login=print('Hi')):
    ...
    class MovieCard:
        ...
        def updateCard(self):
            ...
            self.textLabel = tk.Message(self.details,bg="black",fg="white",width=650,text=self.desc,font=(20))
            ...
            self.number = tk.Message(self.firstRow,bg="black",text='{}.'.format(self.loc),font=(20),fg="white")
            self.title = tk.Message(self.firstRow,width=500,bg="black",text =self.tile, font=(20),fg="white")
            self.year = tk.Message(self.firstRow,width=150,bg="black",text=self.y,fg="white",font=(20))
            self.runtime = tk.Message(self.secondRow,width=250,bg="black",text='{} | '.format(self.time),font=(10),fg="white")
            self.rating = tk.Message(self.thirdRow,width=650,bg="black",text=self.r,font=(10),fg="white")
            self.category = tk.Message(self.secondRow, width=550, bg="black", text=self.genre, font=(10), fg="white")
            self.director = tk.Message(self.fouthRow, width=550, bg="black", text=self.d, font=(10), fg="white")
